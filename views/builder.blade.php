                ...
                <div class="box box-primary col-lg-12">
                    ...
                    <div class="box-body">
                        <form id="form">
                            ...
                            <div class="mb-3 row">
                                <label for="inputPassword" class="col-sm-2 col-form-label">Model Name<span
                            ...
                            <div class="form-group col-md-8 display-none">
                                ...
                                <div class="form-inline form-group" style="border-color: transparent">
                                    ...
                                    <div class="checkbox chk-align" id="chForceMigrate">
                                        <label>
                                            ...
                                            <span class="chk-label-margin">Force Migrate</span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-1 display-none">
                            ...
                            <div class="table-responsive col-md-12">
                                <table class="table table-striped table-bordered" id="table">
                                    <thead>
                                        <tr>
                                            <th>Field Name</th>
                                            <th class="display-none">DB Type</th>
                                            <th class="display-none">Validations</th>
                                            <th>Html Type</th>
                                            <th style="width: 68px" class="display-none">Primary</th>
                                            <th style="width: 80px" class="display-none">Is Foreign</th>
                                            <th style="width: 87px" class="display-none">Searchable</th>
                                            <th style="width: 63px" class="display-none">Fillable</th>
                                            <th style="width: 65px" class="display-none">In Form</th>
                                            <th style="width: 67px" class="display-none">In Index</th>
                                            <th></th>
                                        </tr>
                                    </thead>
                                    <tbody id="container">
                            ...
                            <div class="form-inline col-md-12" style="padding-top: 10px">
                                ...
                                <div class="form-group chk-align display-none" style="border-color: transparent;">
